...
import com.dqs.videostudy.config.appConfig;
...
public class Camera2RecordingActivity extends AppCompatActivity implements TextureView.SurfaceTextureListener {
    ...
    private LineProgressView mProgressView;//录像进度条
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera2_recording);
        initView();
        initTextureView();
    }
    ...
    private void initView() {
        ...
        mProgressView = findViewById(R.id.lineProgressView);
    ...
    private void setupCamera(int width, int height) {
        ...
        try {
            ...
            //选择预览尺寸
            mPreviewSize = Camera2Util.getMinPreSize(map.getOutputSizes(SurfaceTexture.class), width, height, appConfig.PREVIEW_MAX_HEIGHT);
    ...
    private void setupImageReader() {
        ...
        mImageReader.setOnImageAvailableListener(new ImageReader.OnImageAvailableListener() {
            ...
            public void onImageAvailable(ImageReader reader) {
                ...
                Camera2Util.createSavePath(appConfig.PATH_SAVE_PIC);//判断有没有这个文件夹，没有的话需要创建
                picSavePath = appConfig.PATH_SAVE_PIC + "IMG_" + timeStamp + ".jpg";
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    case CAPTURE_OK:
                        ...
                        Log.e(TAG, "handleMessage: 拍照保存完成");
                        if (appConfig.ACTIVITY_AFTER_CAPTURE != null) {
...
//            mProgressView.setIsStart(false);
            ...
            if (currentTime <= MIN_RECORD_TIME) {
                ...
                Log.e(TAG, "录制结束  视频地址= "+videoSavePath);
                if (appConfig.ACTIVITY_AFTER_CAPTURE != null) {
                    /*Intent intent = new Intent(Camera2RecordActivity.this, Camera2Config.ACTIVITY_AFTER_CAPTURE);
...
//        mProgressView.reset();
    ...
    private void prepareMediaRecorder() {
        ...
        try {
            ...
            mCameraDevice.createCaptureSession(surfaces, new CameraCaptureSession.StateCallback() {
                ...
                @Override
                public void onConfigureFailed(CameraCaptureSession session) {
                    Toast.makeText(Camera2RecordingActivity.this, "onConfigureFailed", Toast.LENGTH_SHORT).show();
                }
            }, null);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void setUpMediaRecorder() {
        try {
            ...
            //判断有没有配置过视频地址了
            Camera2Util.createSavePath(appConfig.PATH_SAVE_VIDEO);//判断有没有这个文件夹，没有的话需要创建
            String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(new Date());
            videoSavePath = appConfig.PATH_SAVE_VIDEO + "VIDEO_" + timeStamp + ".mp4";
